...
class DynamicBitArray private constructor(
     ...
     */
    private fun safeBitwiseOperation(
        other: DynamicBitArray,
        op: (UByte?, UByte?) -> UByte,
    ): DynamicBitArray {
     ...
     */
    infix fun and(other: DynamicBitArray): DynamicBitArray =
        safeBitwiseOperation(other) { first, second ->
     ...
     * @return a [DynamicBitArray] containing the result of the operation.
     */
    infix fun or(other: DynamicBitArray): DynamicBitArray =
        safeBitwiseOperation(other) { first, second ->
     ...
     * @return a [DynamicBitArray] containing the result of the operation.
     */
    infix fun xor(other: DynamicBitArray): DynamicBitArray =
        safeBitwiseOperation(other) { first, second ->
